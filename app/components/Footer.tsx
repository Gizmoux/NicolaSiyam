      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-600 hover:text-blue-primary transition-colors">Site Vitrine</a>
              </li>
              <li>
                <a href="#" className="text-gray-600 hover:text-blue-primary transition-colors">E-commerce</a>
              </li>
              <li>
                <a href="#" className="text-gray-600 hover:text-blue-primary transition-colors">Application Web</a>
              </li>
              <li>
                <a href="#" className="text-gray-600 hover:text-blue-primary transition-colors">Refonte de Site</a>
              </li>
              <li>
                <a href="#" className="text-gray-600 hover:text-blue-primary transition-colors">SEO</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center text-gray-500 text-sm">
          <p>&copy; {currentYear} Studio Web. Tous droits réservés.</p>
