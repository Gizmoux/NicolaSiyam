...
const About = () => {
  return (
    <section
      id="about"
      className="section bg-gradient-to-b from-white to-blue-light/20"
    >
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">À propos</h2>
          <p className="text-lg text-gray-600">
            Équipe passionnée spécialisée dans la création de sites web sur
            mesure, on vous accompagne dans la réalisation de votre présence en
            ligne.
          </p>
        </div>
            ...
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-600">
                  Création de sites web performants et responsifs avec les
          ...
          <Card className="card-hover border-pink-soft border-2 rounded-[32px]">
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-600">
                  Conception centrée sur l&apos;utilisateur pour une expérience
                  fluide et intuitive.
                </p>
              </div>
            </CardContent>
          ...
          <Card className="card-hover border-blue-sky border-2 rounded-[32px]">
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-600">
                  Un travail soigné et rigoureux pour des projets livrés dans
                  les délais avec un suivi personnalisé.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                ...
                web, nous avons créer notre activité de freelance pour offrir
                des solutions personnalisées aux entreprises et entrepreneurs.
              </p>
              <p className="text-gray-600">
                Notre mission est de transformer vos idées en solutions
                digitales élégantes et fonctionnelles qui vous démarqueront de
                la concurrence et vous aideront à atteindre vos objectifs.
              </p>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-blue-light/20 p-6 rounded-lg text-center">
                <span className="block text-3xl font-bold text-blue-primary mb-2">
                  5+
                </span>
              ...
              <div className="bg-pink-soft/20 p-6 rounded-lg text-center">
                <span className="block text-3xl font-bold text-pink-light mb-2">
                  5+
                </span>
                <span className="text-sm text-gray-600">Projets réalisés</span>
              </div>
              <div className="bg-blue-sky/20 p-6 rounded-lg text-center">
                <span className="block text-3xl font-bold text-blue-sky mb-2">
                  3+
                </span>
                <span className="text-sm text-gray-600">
                  Clients satisfaits
              ...
              <div className="bg-blue-soft/20 p-6 rounded-lg text-center">
                <span className="block text-3xl font-bold text-blue-soft mb-2">
                  100%
                </span>
                <span className="text-sm text-gray-600">
                  Satisfaction client
