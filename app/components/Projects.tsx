...
const Projects = () => {
  ...
  const projects = [
    ...
    // },
    {
      ...
      title: "ArtFolio",
      category: "Portfolio",
      image: "https://images.unsplash.com/photo-1513542789411-b6a5d4f31634?ixlib=rb-4.0.3&auto=format&fit=crop&w=1974&q=80",
      description: "Portfolio artistique avec galerie d'images immersive et animations élégantes pour une expérience utilisateur unique.",
      technologies: ["React", "GSAP Animations", "Responsive Design", "Lazy Loading"],
      link: "#"
    },
  ];
        ...
        {selectedProject && (
          <Dialog open={open} onOpenChange={setOpen}>
            <DialogContent className="max-w-3xl rounded-card">
              ...
              >
                <DialogHeader>
                  <DialogTitle className="text-2xl font-semibold">{selectedProject.title}</DialogTitle>
                ...
                <DialogFooter>
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Button asChild className="bg-blue-primary hover:bg-blue-sky">
