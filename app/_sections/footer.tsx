  ...
  return (
    <footer className="bg-muted py-12 text-muted-foreground">
      <div className="container grid grid-cols-1 gap-12 md:grid-cols-3">
        <div className="flex flex-col items-start gap-4">
          <Link href="#" className="flex items-center gap-2" prefetch={false}>
            ...
            <span className="text-xl font-bold">NicolaSiyam Agency</span>
          </Link>
          <p className="max-w-[300px] text-sm">
            NicolaSiyam Agency est une agence web de premier plan spécialisée
            dans la création de sites internet à la fois beaux et fonctionnels
      ...
      <div className="mt-12 border-t pt-6 text-center text-xs">
        <p>&copy; 2024 NicolaSiyam Agency. All rights reserved.</p>
      </div>
    </footer>
  );
}
